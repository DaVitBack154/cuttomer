...
const FormSingin = styled.div`
  ...
  .form {
    ...
    transform: translate(
      ${(props) => (props.toggle === 'singin' ? '0%' : '100%')},
      0px
    );
  }
`;
...
const Overlay = styled.div`
  ...
  z-index: 10;
  transform: translate(
    ${(props) => (props.toggle === 'singin' ? '100%' : '0%')},
    0px
  );
  ...
  return (
    <PanelAuthCoomponent>
      <div className="panel-auth__cotnainer">
        <Layer1>
          <FormSingin toggle={toggle}>
            <div className="form">
              <FormLogin className="form" />
            </div>
          </FormSingin>
          <FormSingup toggle={toggle}>
            <div className="form">
              <FormRegister className="form" setToggle={setToggle} />
            </div>
          </FormSingup>
        </Layer1>
        <Layer2>
          <Overlay toggle={toggle}>
            {toggle === 'singin' ? (
              <div className="overlay">
                <div>
                  <div className="head-text">ERP MANAGEMENT</div>
                </div>
